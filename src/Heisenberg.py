...
class Heisenberg2D:
    ...
    def vecinosp(self, i, j):
        r"""Returns the neighboring spins of a spin at position (i, j).
        """
    ...
    def Ein(self,mu,h_3):
        r"""Calculates the energy contribution of a spin with its neighboring spins.
        """
        sum = 0
        if self.Jm != 0:
